...
user/_test_trigger:     file format elf64-littleriscv
...
int main() {
   ...
   6:	0800                	addi	s0,sp,16
    // صدا زدن سیستم کال trigger
    trigger(); 
   8:	31a000ef          	jal	ra,322 <trigger>
    return 0;
}
   c:	4501                	li	a0,0
   e:	60a2                	ld	ra,8(sp)
...
start()
{
  ...
  extern int main();
  main();
  1e:	fe3ff0ef          	jal	ra,0 <main>
  exit(0);
  22:	4501                	li	a0,0
  24:	25e000ef          	jal	ra,282 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 15c:	892e                	mv	s2,a1
  ...
  fd = open(n, O_RDONLY);
 15e:	4581                	li	a1,0
 160:	162000ef          	jal	ra,2c2 <open>
  if(fd < 0)
 164:	02054163          	bltz	a0,186 <stat+0x36>
 168:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 16a:	85ca                	mv	a1,s2
 16c:	16e000ef          	jal	ra,2da <fstat>
 170:	892a                	mv	s2,a0
  close(fd);
 172:	8526                	mv	a0,s1
 174:	136000ef          	jal	ra,2aa <close>
  return r;
}
 178:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 26e:	f67ff0ef          	jal	ra,1d4 <memmove>
}
 272:	60a2                	ld	ra,8(sp)
 274:	6402                	ld	s0,0(sp)
